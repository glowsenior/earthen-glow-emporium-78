    ...
    <footer className="bg-ceramic-navy text-white pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">
              Handcrafted ceramic products and natural cosmetics made with love and care.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-serif font-bold mb-4">Shop</h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row gap-4 justify-between items-start">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-sm text-gray-300 mb-4">Get the latest updates on new products and upcoming sales</p>
              <div className="flex gap-2">
                <input type="email" placeholder="Your email" className="flex-1 px-4 py-2 rounded bg-white/10 text-white border border-gray-600 focus:outline-none focus:ring-1 focus:ring-ceramic-terracotta" />
                <button className="bg-ceramic-terracotta hover:bg-ceramic-clay text-white px-4 py-2 rounded">Subscribe</button>
              </div>
            </div>
            <div className="w-full md:w-1/3 mt-6 md:mt-0">
              <h3 className="text-lg font-serif font-bold mb-2">Contact Us</h3>
              <address className="not-italic text-sm text-gray-300">
                <p>123 Ceramic Lane</p>
                <p>Clay District, CA 90210</p>
                <p className="mt-2">Email: info@earthenglow.com</p>
        ...
        <div className="mt-12 pt-6 border-t border-gray-700 text-sm text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} EarthenGlow. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
